...
class PagamentosConcurrentIT {
    ...
    fun setup() {
        ...
        assertThat(requestRepository.countByStatus(RequestStatus.PENDING)).isEqualTo(500)
    }
    ...
    fun fiveConcurrentCallsProcessAllRows() {
        ...
        assertThat(pagamentoRepository.count()).isEqualTo(500)
